<template>
  <div class="d-flex flex-column align-items-center jusfity-content-center p-3">
    ...
    <div v-if="loading" class="fa-3x">
      ...
      ><span
        >This app runs on Heroku with limited dynos. The first time it runs, it
        takes a long time to wake up the app. Please be patient as it
        loads</span
      >
    </div>
    <iframe
      v-on:load="toggleOnLoadIcon"
      class="mx-auto my-2"
      id="RonSwanson"
