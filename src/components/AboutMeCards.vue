  ...
  <div class="card-columns w-75 mx-auto">
    ...
    <div class="card bg-success">
        ...
        <div class="techIcons">
          ...
          <h4 class="card-text text-white">Written with React and interacts with a API server both hosted on Heroku. The app lets you rates quotes, only once per IP address and tracks them with a PostgreSQL database also hosted on a serparate server on Heroku. Simple, humorous but highlights my backend and frontend skills.</h4>
        </div>
        ...
        <div class="card-footer d-flex justify-content-around my-3">
          ...
          <a href="https://github.com/keugenio/Ron-Swanson" class="btn btn-success border-dark-blue" target="_blank">
            <i class="fab fa-github rounded" aria-hidden="true"></i>
          </a>
        </div>
    </div>
...
export default {
  name: 'AboutMeCards',
  components: {Clicky, RonSwanson, Marvel},
  methods: {
    showModal (modalName) {
